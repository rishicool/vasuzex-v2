...
Cleanup-test application with authentication and framework integration.

## Structure

```
apps/cleanup-test/api/
├── src/
...
```bash
pnpm dev:cleanup-test-api
```

Or from app directory:

```bash
cd apps/cleanup-test/api
pnpm dev
```
