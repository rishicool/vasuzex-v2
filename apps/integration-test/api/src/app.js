/**
 * IntegrationTest API Application
...
/**
 * IntegrationTestApp - Extends BaseApp
 * Organized and maintainable Express app configuration
 */
class IntegrationTestApp extends BaseApp {
  constructor() {
    super({
      serviceName: process.env.APP_NAME || 'integration-test-api',
